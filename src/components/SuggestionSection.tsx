    ...
    <div className="bg-white h-max mt-10 lg:p-14 p-8">
      <div>
        ...
        <div className="relative">
          <div className="absolute -top-32 left-full transform -translate-y-1/2 -ml-8 bg-white p-4 rounded-full cursor-pointer">
            <FaAngleRight className="text-[#757779]" />
          </div>
        </div>
        <div className="relative">
          <div className="absolute -top-32 left-0 transform -translate-y-1/2 -ml-8 bg-white p-4 rounded-full cursor-pointer">
