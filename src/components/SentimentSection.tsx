            ...
            <div className="p-4 flex">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                ...
                <div className="relative">
                  <div className="absolute top-12 left-[360px] transform -translate-y-1/2 -ml-8 bg-white p-4 rounded-full cursor-pointer">
          ...
          <div className="flex mt-2">
            ...
            <div className="lg:px-10 px-2 mt-2">
              <div className="flex p-2 items-center">
                <div className="text-[#7C7E8C]z text-[15px] mr-9">Buy</div>
